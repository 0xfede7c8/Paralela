         ...
         float tlow, float thigh, unsigned char **edge, char *fname)
{
    ...
    ****************************************************************************/
    ...
    tfin = omp_get_wtime();
    printf("No_max_suppression Took: %f\n", tfin-tini);
    ...
    tfin = omp_get_wtime();
    printf("Apply_hysteresis Took: %f\n", tfin-tini);
